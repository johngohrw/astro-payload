...
- **Placeholder images:** `https://picsum.photos/400` (returns a 400×400 random JPEG)
- For different sizes, use: `https://picsum.photos/800/600` etc.
...
<article class="flex flex-col items-start justify-between">
  <div class="relative w-full">
    <img src="https://picsum.photos/800/450" alt="" class="aspect-video w-full rounded-2xl bg-gray-100 object-cover sm:aspect-2/1 lg:aspect-3/2 dark:bg-gray-800" />
  ...
  <div class="flex max-w-xl grow flex-col justify-between">
    ...
    <div class="relative mt-8 flex items-center gap-x-4 justify-self-end">
      <img src="https://picsum.photos/400" alt="" class="size-10 rounded-full bg-gray-100 dark:bg-gray-800" />
      <div class="text-sm/6">
...
<figure class="mt-10">
  ...
  <figcaption class="mt-10">
    <img src="https://picsum.photos/400" alt="" class="mx-auto size-10 rounded-full" />
...
1. **File:** A single `.html` file named descriptively (e.g., `featThreeColumnWithIcons.html`, `heroSplitWithImage.html`)
...
5. **Mock images:** Use `https://picsum.photos/400` (or size variants) for all placeholder images
...
9. **Name the file** using the camelCase convention: `{type}{Descriptor}.html`
...
- `featThreeColumnWithIcons.html`
- `pricingThreeTiersWithToggle.html`
- `blogWithFeaturedPost.html`
- `ctaSimpleJustified.html`
- `teamGridWithRoundImages.html`
- `testimonialsSimpleCentered.html`
- `statsSimpleGrid.html`
- `newsletterSimpleSideBySide.html`
- `contactSplitWithImage.html`
- `footerWithNewsletter.html`
- `faqTwoColumns.html`
- `bentoThreeColumnBentoGrid.html`
