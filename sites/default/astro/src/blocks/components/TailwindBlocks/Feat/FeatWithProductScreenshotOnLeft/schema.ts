...
export const featWithProductScreenshotOnLeftSchema: Block = {
  slug: "featWithProductScreenshotOnLeft",
  labels: { singular: "Feat With Product Screenshot On Left", plural: "Feat With Product Screenshots On Left" },
  fields: [
