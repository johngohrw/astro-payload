...
export const ctaSimpleCenteredWithGradientSchema: Block = {
  slug: "ctaSimpleCenteredWithGradient",
  labels: {
    singular: "Cta Simple Centered With Gradient",
    plural: "Cta Simple Centered With Gradients",
  },
  fields: [
    {
      name: "heading",
